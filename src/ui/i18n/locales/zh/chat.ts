...
export const chat = {
  chat: {
    ...
    usage: {
      ...
      contextWindow: "上下文窗口",
      contextUsed: "{used} / {total} tokens",
      contextEstimated: "估算",
      contextUnmeasured: "发送一条消息即可测量上下文窗口。",
      contextAutoCompaction: "达到 {limit} 时自动压缩",
      contextCompactions: "已压缩 {count} 次",
      compactNow: "压缩上下文",
      compacting: "正在压缩上下文…",
      compactEmpty: "当前还没有可压缩的对话上下文。",
      compactedFreed: "上下文已压缩，释放约 {tokens} tokens。",
