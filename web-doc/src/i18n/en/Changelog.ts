  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Pending edit_file and apply_patch previews no longer steal focus: the inline change preview reuses an editor that already shows the affected file, otherwise it opens a transient preview tab in the column where the file is already tabbed, and it hands focus back to the user's editor when the platform activates the shown editor despite being asked to preserve focus, which is what macOS does. A confirmation therefore never interrupts chat input, terminal work, or typing elsewhere.",
