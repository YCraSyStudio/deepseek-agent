  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Los previews pendientes de edit_file y apply_patch ya no roban el foco: el preview inline reutiliza un editor que ya muestra el archivo afectado y, si no existe, abre una pestaña de preview transitoria en la columna donde el archivo ya está abierto, y devuelve el foco al editor del usuario cuando la plataforma activa el editor mostrado aunque se le pida preservar el foco, que es lo que hace macOS. Una confirmación, por tanto, ya no interrumpe la escritura en el chat, el trabajo en el terminal ni la edición en otro lugar.",
